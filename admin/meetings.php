<?php
  ...
  try{
      $sql = "SELECT id, meeting_date, title, active FROM meeting";
                      ...
                      <tbody>
                        <?php
                          foreach ($result as $meeting)
                          {
                            ...
                            $meeting_date = date('j M Y', $date); 
                            $title = $meeting['title']; 
                            $active = $meeting['active']?"Yes":"No";       
                        ?>
                        <tr>
                          ...
                          <td><a href="deleteMeeting.php?id=<?php echo $id ?>" onclick="return checkDelete()"><img src="./images/delete.png" alt="Delete"></a></td>
                        </tr>
                        <?php
                        }    
                        ?>
